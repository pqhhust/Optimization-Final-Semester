...
# =========================================================
# 1. INPUT HANDLING (Logic từ greedy_tabu_new)
# =========================================================
def input_data():
    try:
...
# =========================================================
# 2. GRASP INITIALIZER (Logic từ greedy_tabu_new / up_chien2)
# =========================================================
...
# =========================================================
# 3. METROPOLIS SOLVER (Logic từ metropolis.py, có init_x/y)
# =========================================================
class MetropolisSolver:
    def __init__(self, N, M, K, a, b, c, d, e, f, s_matrix, g_matrix, t_list, init_x=None, init_y=None):
        ...
        if init_x and init_y:
            self.x = list(init_x)
            self.y = list(init_y)
            # Greedy có thể chưa gán hết (giá trị 0), cần fill random để có Full Solution
...
if __name__ == '__main__':
    ...
    if data:
        ...
        # 2. Chạy Metropolis
        metro = MetropolisSolver(N, M, K, a, b, c, d, e, f, s, g, t, init_x, init_y)
        metro.solve()
        
        # 3. In kết quả cuối cùng
        out_N, out_x, out_M, out_y = metro.get_result()
        print(out_N)
        print(*(out_x))
        print(out_M)
        print(*(out_y))